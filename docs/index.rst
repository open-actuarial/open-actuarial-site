.. Open Actuarial documentation master file, created by
   sphinx-quickstart on Mon Oct 30 22:31:29 2017.
...
An organisation for the promotion of open approaches to actuarial problems.

The actuarial community benefits from a wide range of commercial tools and a considerable amount of actuarial research but that research rarely produces tools that can be easily implemented by the actuarial community. This organisation aims to:
...
---------------------------
- Discuss on Gitter
- Submit pull requests to improve this wiki
